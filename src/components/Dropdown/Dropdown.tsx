  ...
  return (
    <div className="relative inline-block w-full min-w-[130px]">
      <button
        ...
        className="w-full text-black bg-white hover:bg-gray-300 border-2 border-black font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center min-w-[130px] gap-3 justify-between"
        type="button"
      >
        {title}
        <ArrowDownIcon />
